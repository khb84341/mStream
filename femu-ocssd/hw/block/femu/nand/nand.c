...
static void init_nand_flash_timing(FemuCtrl *n)
{
    ...
    nand_flash_timing.pg_rd_lat[MLC][MLC_LOWER_PAGE] = MLC_LOWER_PAGE_READ_LATENCY_NS;
    nand_flash_timing.pg_rd_lat[MLC][MLC_UPPER_PAGE] = MLC_UPPER_PAGE_READ_LATENCY_NS;
    nand_flash_timing.pg_wr_lat[MLC][MLC_LOWER_PAGE] = MLC_LOWER_PAGE_WRITE_LATENCY_NS;
    nand_flash_timing.pg_wr_lat[MLC][MLC_UPPER_PAGE] = MLC_UPPER_PAGE_WRITE_LATENCY_NS;

    nand_flash_timing.blk_er_lat[SLC] = SLC_BLOCK_ERASE_LATENCY_NS;
    nand_flash_timing.blk_er_lat[MLC] = MLC_BLOCK_ERASE_LATENCY_NS;
    nand_flash_timing.blk_er_lat[TLC] = TLC_BLOCK_ERASE_LATENCY_NS;
    nand_flash_timing.blk_er_lat[QLC] = QLC_BLOCK_ERASE_LATENCY_NS;

    nand_flash_timing.chnl_pg_xfer_lat[SLC] = SLC_CHNL_PAGE_TRANSFER_LATENCY_NS;
    nand_flash_timing.chnl_pg_xfer_lat[MLC] = MLC_CHNL_PAGE_TRANSFER_LATENCY_NS;
    nand_flash_timing.chnl_pg_xfer_lat[TLC] = TLC_CHNL_PAGE_TRANSFER_LATENCY_NS;
    nand_flash_timing.chnl_pg_xfer_lat[QLC] = QLC_CHNL_PAGE_TRANSFER_LATENCY_NS;
}
